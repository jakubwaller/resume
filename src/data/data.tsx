  ...
  description: (
    <>
      <p className="prose-sm text-ink-200 sm:prose-base lg:prose-lg">
        I'm a Hamburg-based{' '}
        <a
          className="font-semibold text-white underline decoration-brand-500/50 underline-offset-4 transition-colors hover:text-brand-400 hover:decoration-brand-400"
          href="https://github.com/jakubwaller">
          Data Scientist
        </a>
        , working in climate, at{' '}
        <a
          className="font-semibold text-white underline decoration-emerald-500/50 underline-offset-4 transition-colors hover:text-emerald-300 hover:decoration-emerald-400"
          href="https://www.shipzero.com">
          shipzero
        </a>
      ...
      <p className="prose-sm text-ink-300 sm:prose-base lg:prose-lg">
        ...
        <a className="font-medium text-ink-100 hover:text-brand-400" href="https://www.strava.com/athletes/22414933">
          cycling
        </a>{' '}
        Planet A, exploring its climate in various warming scenarios (+1.5°, +2.0°…) using my{' '}
        ...
        <a
          ...
          href="https://www.goodreads.com/user/show/121850617-jakub">
          interesting book
        </a>
        , or playing the{' '}
        <a
          className="font-medium text-ink-100 hover:text-brand-400"
          href="https://open.spotify.com/album/693WL6HmksSvOJv7pEbsDt?si=ay_RBOGuQeacbq5WaDa-qA">
          guitar
        </a>
        .
      </p>
...
export const aboutData: About = {
  ...
  description: (
    <p className="prose prose-sm text-zinc-300 sm:prose-base">
      For the past 2+ years I've been a Data Scientist at{' '}
      <a className="font-semibold text-zinc-100 hover:text-orange-400" href="https://www.shipzero.com">
        shipzero
      </a>
      , helping decarbonise global supply chains — building emission models, ML pipelines and data products that turn
      messy logistics data into actionable carbon insights. Because there is no Planet B.
      <br></br>
      <br></br>
      Before that, I spent five years at Qimia GmbH on a wide range of Data Science, Machine Learning and Data
      Engineering projects, then took a year off to travel around our beautiful Planet A. That trip is what convinced me
      to dedicate the rest of my career to climate and data.
      <br></br>
      <br></br>I graduated from the Czech Technical University in Prague with a master's thesis on time series
  ...
  aboutItems: [
    ...
    {label: 'Interests', text: <>Cycling, books, music</>, Icon: SparklesIcon},
    {
      ...
      text: (
        <>
          Czech Technical University of Prague,<br></br>University of Waterloo,<br></br>TalTech – Tallinn University of
          Technology
        </>
      ),
...
export const education: TimelineItem[] = [
  {
    ...
    content: (
      <>
        Study Field: Knowledge Engineering
        <br></br>Main Topics: Pattern Recognition, Data Mining Algorithms, Data Preprocessing, Enterprise Data Warehouse
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <br></br>Main Topics: Programming Languages and Compilers, Algorithms, Operating Systems, Database Systems,
...
export const experience: TimelineItem[] = [
  ...
  },
  {
    ...
    content: (
      <p>
        Working on various projects involving Data Science, Machine Learning and Data Engineering topics using a wide
  ...
  },
  {
    ...
    content: (
      <p>
        Comparing various architectures of artificial neural networks (convolutional neural networks, long short-term
        memory neural networks, and gated recurrent units) on a set of time series classification data sets in terms of
        the ability to learn, the effectivity of the training process, and the classification performance.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>Programming SAP portal applications in Java, AngularJS and HTML for a web portal for ČEZ Distribuce, a.s.</p>
    ),
  },
  {
    ...
    content: (
      <p>Maintenance of computers and other technical devices at the Institute of Immunology and Microbiology.</p>
    ),
  },
  {
    ...
    content: <p>Extracting information from rRNA using various bioinformatics software.</p>,
  },
];
...
export const certificates: TimelineItem[] = [
  {
    ...
    content: (
      <a
        className="inline-flex items-center gap-x-2 text-sm text-ink-300 hover:text-brand-400 transition-colors"
        href="https://www.linkedin.com/learning/certificates/ad65c2c4c6ad87bc476f8308bf3185805aa8a70071438cc6f0fde85b76a4c168?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_certifications_details%3BOfP6%2BP6RTmSyvxLP6Olcig%3D%3D"
        rel="noreferrer"
        target="_blank">
  ...
  },
  {
    ...
    content: (
      <a
        className="inline-flex items-center gap-x-2 text-sm text-ink-300 hover:text-brand-400 transition-colors"
        href="https://www.linkedin.com/learning/certificates/9c290adfe6810e8beeb79a99b78df0375d6d3f0c3636c9b7a053495641d79bd1?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_certifications_details%3BOfP6%2BP6RTmSyvxLP6Olcig%3D%3D"
        rel="noreferrer"
        target="_blank">
        <span className="inline-flex items-center gap-x-2">
          <ArrowDownTrayIcon className="h-4 w-4" />
  ...
  },
  {
    ...
    content: (
      <a
        className="inline-flex items-center gap-x-2 text-sm text-ink-300 hover:text-brand-400 transition-colors"
        href="https://www.kaggle.com/learn/certification/jakubwaller/data-visualization"
        rel="noreferrer"
        target="_blank">
        <span className="inline-flex items-center gap-x-2">
          <ArrowDownTrayIcon className="h-4 w-4" />
  ...
  },
  {
    ...
    content: (
      <a
        className="inline-flex items-center gap-x-2 text-sm text-ink-300 hover:text-brand-400 transition-colors"
        href="https://www.coursera.org/account/accomplishments/certificate/53REXCQ5PHHX"
        rel="noreferrer"
        target="_blank">
        <span className="inline-flex items-center gap-x-2">
          <ArrowDownTrayIcon className="h-4 w-4" />
  ...
  },
  {
    ...
    content: (
      <a
        className="inline-flex items-center gap-x-2 text-sm text-ink-300 hover:text-brand-400 transition-colors"
        href="https://www.coursera.org/account/accomplishments/specialization/certificate/ZM4TB7LFHRFA"
        rel="noreferrer"
        target="_blank">
        <span className="inline-flex items-center gap-x-2">
          <ArrowDownTrayIcon className="h-4 w-4" />
  ...
  },
  {
    ...
    content: (
      <a
        className="inline-flex items-center gap-x-2 text-sm text-ink-300 hover:text-brand-400 transition-colors"
        href="https://www.coursera.org/account/accomplishments/certificate/XST476L3DT42"
        rel="noreferrer"
        target="_blank">
        <span className="inline-flex items-center gap-x-2">
          <ArrowDownTrayIcon className="h-4 w-4" />
  ...
  },
  {
    ...
    content: (
      <a
        className="inline-flex items-center gap-x-2 text-sm text-ink-300 hover:text-brand-400 transition-colors"
        href="https://www.coursera.org/account/accomplishments/certificate/5SGQK7P4T73Z"
        rel="noreferrer"
        target="_blank">
        <span className="inline-flex items-center gap-x-2">
          <ArrowDownTrayIcon className="h-4 w-4" />
  ...
  },
  {
    ...
    content: (
      <a
        className="inline-flex items-center gap-x-2 text-sm text-ink-300 hover:text-brand-400 transition-colors"
        href="https://www.coursera.org/account/accomplishments/certificate/94AA8LVBEA3G"
        rel="noreferrer"
        target="_blank">
        <span className="inline-flex items-center gap-x-2">
          <ArrowDownTrayIcon className="h-4 w-4" />
  ...
  },
  {
    ...
    content: <>Course Certificate ID: H828-3446</>,
  },
];
